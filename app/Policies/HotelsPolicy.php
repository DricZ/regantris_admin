...
class HotelsPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Hotels');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Hotels');
    }

    /**
     * Determine whether the user can replicate the model.
     */
    public function replicate(User $user, Hotels $hotels): bool
    {
        return $user->checkPermissionTo('replicate Hotels');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Hotels');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Hotels');
    }
}
